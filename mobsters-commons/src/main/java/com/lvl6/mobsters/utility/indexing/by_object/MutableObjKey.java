 ...
 *
 */
public final class MutableObjKey<T extends Comparable<? super T>> extends AbstractObjComparable<T> {
	private T id;
	
	public MutableObjKey() {
		// id begins with a default value of null and is not initially usable.
		id = null;
	}
	 ...
	 */
    public MutableObjKey(T initialValue) {
	 ...
	 * @throws NullPointerException if initialValue is null.
	 */
	public void setOrderingObj(T id) {
		Preconditions.checkNotNull(id);
		this.id = id;
	}
}
