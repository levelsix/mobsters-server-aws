...
public class StructureForUser
{
	...
	public StructureForUser( final String id, final String userId, final int structId,
	    final Date lastRetrieved, final CoordinatePair coordinates, final Date purchaseTime,
	    final boolean isComplete, final String orientation, final int fbInviteStructLvl )
	{
		super();
		this.id = id;
		this.userId = userId;
