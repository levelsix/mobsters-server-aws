...
/*	@DynamoDBHashKey(attributeName = "id")
	...
	public QuestForUser(){}
	public QuestForUser(String userId, String questId, boolean isRedeemed,	boolean isComplete) {
		super();
		this.userId = userId;
...
*/
	...
	public String toString() {
		return "QuestForUser [version=" + version + ", userId=" + userId + ", questId=" + questId
