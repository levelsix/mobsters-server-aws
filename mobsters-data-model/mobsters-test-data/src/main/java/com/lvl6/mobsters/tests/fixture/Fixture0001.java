...
public class Fixture0001 implements PartialDataSet {
	...
	public void repopulate() {
		...
		monsterForUserRepo.save(monsterOneForUserOne);
		monsterForUserRepo.save(monsterTwoForUserOne);
	}
