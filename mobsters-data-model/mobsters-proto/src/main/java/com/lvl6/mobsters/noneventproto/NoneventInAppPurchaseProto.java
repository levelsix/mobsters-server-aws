...
public final class NoneventInAppPurchaseProto {
  ...
  public static final class GoldSaleProto extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.internal_static_proto_GoldSaleProto_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.internal_static_proto_GoldSaleProto_fieldAccessorTable;
    }
    ...
    public static com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto parseFrom(
    ...
    public static com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto parseFrom(
    ...
    public static com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProtoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.internal_static_proto_GoldSaleProto_descriptor;
      }
      ...
      // Construct using com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto.getDescriptor();
      }
      
      public com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto getDefaultInstanceForType() {
        return com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto.getDefaultInstance();
      }
      
      public com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto build() {
        com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto buildPartial() {
        com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto result = new com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto) {
          return mergeFrom((com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto other) {
        if (other == com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto.getDefaultInstance()) return this;
        if (other.hasSaleId()) {
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_proto_GoldSaleProto_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto.class,
              com.lvl6.mobsters.noneventproto.NoneventInAppPurchaseProto.GoldSaleProto.Builder.class);
          return null;
        }
      };
