...
@ContextConfiguration({"classpath:spring-db.xml", "classpath:spring-redis.xml", "classpath:spring-dynamo.xml", "classpath:spring-services.xml", "classpath:spring-local-test-fixtures.xml"})
