...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Pending Operation Internal</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link com.lvl6.mobsters.domainmodel.player.PendingOperationInternal#getPlayer <em>Player</em>}</li>
 *   <li>{@link com.lvl6.mobsters.domainmodel.player.PendingOperationInternal#getOpStartTimer <em>Op Start Timer</em>}</li>
 *   <li>{@link com.lvl6.mobsters.domainmodel.player.PendingOperationInternal#getOpEndTimer <em>Op End Timer</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PendingOperationInternal extends PendingOperation {
	 ...
	 * It is bidirectional and its opposite is '{@link com.lvl6.mobsters.domainmodel.player.PlayerInternal#getPendingOperations <em>Pending Operations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link com.lvl6.mobsters.domainmodel.player.PendingOperationInternal#getPlayer <em>Player</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link com.lvl6.mobsters.domainmodel.player.PendingOperationInternal#getOpStartTimer <em>Op Start Timer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Op Start Timer</em>' attribute.
	 * @see #getOpStartTimer()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link com.lvl6.mobsters.domainmodel.player.PendingOperationInternal#getOpEndTimer <em>Op End Timer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Op End Timer</em>' attribute.
	 * @see #getOpEndTimer()
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%java.util.Date%> now = <%com.lvl6.mobsters.utility.common.TimeUtils%>.createNow();\nboolean retVal = false;\n<%java.util.Date%> _opEndTimer = this.getOpEndTimer();\nboolean _lessThan = (_opEndTimer.compareTo(now) < 0);\nif (_lessThan)\n{\n\tthis.happen();\n\tretVal = true;\n}\nreturn retVal;'"
	 * @generated
	 */
	boolean checkTimer();
