...
public interface CombineMonsterPiecesInternal extends PendingOperationInternal {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>New Monster</em>' reference isn't clear, there
	 ...
	 * {@link com.lvl6.mobsters.domainmodel.player.CombineMonsterPiecesInternal#getNewMonster
	 * <em>New Monster</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>New Monster</em>' reference.
	 * @see #getNewMonster()
	 * @generated
	 */
